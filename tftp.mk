...
# $(shell rm -rf  $(TARGET_OUT_VENDOR_DATA)/rfs/)
# $(shell mkdir -p $(TARGET_OUT_VENDOR_DATA)/rfs/msm/mpss/)
# $(shell mkdir -p $(TARGET_OUT_VENDOR_DATA)/rfs/msm/adsp/)
# $(shell mkdir -p $(TARGET_OUT_VENDOR_DATA)/rfs/mdm/mpss/)
# $(shell mkdir -p $(TARGET_OUT_VENDOR_DATA)/rfs/mdm/adsp/)
